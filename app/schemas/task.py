...
def parse_task_detail(task_orm) -> dict:
    ...
    base = {
        ...
        "agent_mission_plan": parsed.get("agent_mission_plan"),
        "agent_roster": parsed.get("agent_roster"),
        "agent_delegation_trace": parsed.get("agent_delegation_trace"),
        "agent_react_trace": parsed.get("agent_react_trace"),
        "agent_actions": parsed.get("agent_actions"),
        "agent_action_observations": parsed.get("agent_action_observations"),
        "agent_action_diagnostics": parsed.get("agent_action_diagnostics"),
        "agent_tool_calls": parsed.get("agent_tool_calls"),
        "agent_observations": parsed.get("agent_observations"),
        "agent_evidence": parsed.get("agent_evidence"),
        "agent_protocol_evaluations": parsed.get("agent_protocol_evaluations"),
        "agent_protocol_summary": parsed.get("agent_protocol_summary"),
        ...
        "agent_strategy_diagnostics": parsed.get("agent_strategy_diagnostics"),
