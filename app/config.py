...
class Settings(BaseSettings):
    ...
    AGENT_PLAN_LLM_TIMEOUT_SECONDS: float = 12.0
    AGENT_TASK_SOFT_TIME_LIMIT_SECONDS: int = 2700
    AGENT_TASK_TIME_LIMIT_SECONDS: int = 3000
    AGENT_RUNTIME_VERSION: str = "v1"
    AGENT_V2_MAX_TURNS: int = 50
    AGENT_V2_LLM_TIMEOUT_SECONDS: float = 60.0
    AGENT_V2_LLM_MAX_TOKENS: int = 4096
    AGENT_V2_LLM_RETRY_COUNT: int = 1
    AGENT_V2_OPENAPI_FETCH_TIMEOUT_SECONDS: float = 30.0
    AGENT_V2_BATCH_HTTP_GET_LIMIT: int = 50
    AGENT_V2_APPROVAL_TIMEOUT_SECONDS: float = 300.0
    AGENT_V2_APPROVAL_POLL_INTERVAL_SECONDS: float = 1.0
